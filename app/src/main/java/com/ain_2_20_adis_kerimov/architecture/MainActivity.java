...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Note note) {
                ...
                intent.putExtra(AddEditNoteActivity.EXTRA_TEL, note.getTel());
                intent.putExtra(AddEditNoteActivity.EXTRA_EMAIL, note.getEmail());
                intent.putExtra(AddEditNoteActivity.EXTRA_SPEC, note.getSpec());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK) {
            ...
            String tel = data.getStringExtra(AddEditNoteActivity.EXTRA_TEL);
            String email = data.getStringExtra(AddEditNoteActivity.EXTRA_EMAIL);
            String spec = data.getStringExtra(AddEditNoteActivity.EXTRA_SPEC);

            Note note = new Note(name, tel, email, spec);
